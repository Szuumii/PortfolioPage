...
export const descriptions = {
  css: "Visual aspect is something that makes or breakes the web page. With CSS3 and SASS I'm able to create beautiful and responsive designs that are not only visually pleasing but also extensible and easy to modify.",
  ...
  fastapi: "This awesome python restAPI library is a lightweight masterpiece. Using it I can set up a backend site for my applications almost instantly. It is a perfect solution for both small projects as well as those that scale to larger ones.",
  cplusplus: "C++ is the first language that I've ever learned. It has given me opportunities to create amazing projects and grow up as a coder. This experience eventually led me to land my first internship. With C++ as a baseline I can work with any other strongly typed language without any problems.",
  react: "React is my go to front end library. It provides me with tools to create virtually any UI that is required. Thorough knowledge of HooksAPI and JSX allows me to create extensible and reusable components giving me a way to scale my codbase really fast.",
  ...
  python: "Python is my favourite language to use for every task. It's flexibility and simplicy makes it extremely powerfull tool to have in my tech stack. Strong knowledge of advanced contepts like closures, generators, decorators and comprehensions make my code simple and efficient.",
